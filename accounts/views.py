...
class UserRegistrationEmailView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            print("random code is ", random_code)
            ...
            print("request.session['user_registration_info'] is", request.session['user_registration_info'])
...
class UserRegistrationConfirmationView(APIView):
    ...
    print("serializer_class is ", serializer_class)

    def post(self, request):

        # Check the code
        serializer = self.serializer_class(data=request.data)
        print("serializer is 2", serializer)
        serializer.is_valid(raise_exception=True)
        code = serializer.validated_data['code']
        print("code is ", code)

        # Check user information
        user_registration_info = request.session.get('user_registration_info') or request.data.get(
            'user_registration_info')
        print("user_registration_info is", user_registration_info)
...
class ProfileView(APIView):
    ...
    def get(self, request, username):
        ...
        print("is_following is", is_following)
        is_owner = request.user == user
        print("request.user is", request.user)
        print("user is", user)
        print("is_owner is", is_owner)
        full_access_to_profile = request.user == user or is_following or not user.private
        print("full_access_to_profile is", full_access_to_profile)
        ...
        print("profile_serializer is", profile_serializer)
...
class UserProfilePosts(ListAPIView):
    ...
    print("pagination_class is", pagination_class)
    ...
    def list(self, request, *args, **kwargs):
        ...
        print("request.user is",request.user)
        print("user is",user)
        print("access_to_posts is", access_to_posts)
...
class EditProfileView(APIView):
    ...
    def put(self, request):
        ...
        print("serializer1 is",serializer)
        if serializer.is_valid():
            serializer.save()
            return Response(serializer.data, status=200)
        return Response(serializer.errors, status=400)
